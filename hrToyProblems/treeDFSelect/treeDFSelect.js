...
Tree.prototype.DFSelect = function(filter, depth = 0) {
  ...
  return filteredNodes.concat(this.children.reduce((accumulator, child) => {
    return accumulator.concat(child.DFSelect(filter, depth + 1));
  }, []));
};
...
let result1 = root1.DFSelect(function(value, depth) {
  return value % 2;
})
// [1, 5, 3, 7]

let result2 = root1.DFSelect(function(value, depth) {
  return depth === 1;
})
// [2, 3]
